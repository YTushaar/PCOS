...
with st.sidebar:
    ...
    st.markdown(
        ...
        By leveraging machine learning techniques, this project aims to analyze user-inputted medical data—such as ovarian follicle counts, AMH levels, and lifestyle factors—to predict the likelihood of PCOS. The application will provide users with instant feedback on their health status, empowering them to make informed decisions.
        """
    )


# Title
st.title('PCOS Identifier')
